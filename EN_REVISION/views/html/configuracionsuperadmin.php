<!doctype html>
<html lang="en">
<<<<<<< HEAD:views/html/configuracionsuperadmin.html
=======
  <head>
    <meta charset="UTF-8">                      
...
>>>>>>> master:views/html/configuracionsuperadmin.php
    ...
    <div class="row">
      <div class="col-2" style="height: 100vh; ">
        <div class="sidenav">
          ...
          <a href="configuracionsuperadmin.html" style="background-color: #e65d08"><i
              class="fa fa-cogs"></i>Configuración</a>
